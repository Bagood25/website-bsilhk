...
<footer class="bg-gray-900 text-gray-300 py-12 relative">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-8 border-b border-gray-700 pb-8">
            ...
            <!-- Kolom Tentang BSILHK -->
            <div>
                <h3 class="text-xl font-bold mb-4 text-white">Tentang BSILHK</h3>
                <ul class="space-y-2 text-sm">
                    <li><a href="#" class="hover:text-green-500 transition duration-300">Profil BSILHK</a></li>
                    <li><a href="#" class="hover:text-green-500 transition duration-300">Dasar Hukum</a></li>
                    <li><a href="#" class="hover:text-green-500 transition duration-300">Tugas dan Fungsi</a></li>
                    <li><a href="#" class="hover:text-green-500 transition duration-300">Struktur Organisasi</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="#" class="hover:text-green-500 transition duration-300">Fokus BSI</a></li>
                    <li><a href="#" class="hover:text-green-500 transition duration-300">Kabar BSI</a></li>
                    <li><a href="#" class="hover:text-green-500 transition duration-300">Berita Standar</a></li>
                    <li><a href="#" class="hover:text-green-500 transition duration-300">Berita KLHK</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="#" class="hover:text-green-500 transition duration-300">Undang-undang</a></li>
                    <li><a href="#" class="hover:text-green-500 transition duration-300">Peraturan Pemerintah</a></li>
                    <li><a href="#" class="hover:text-green-500 transition duration-300">Peraturan Presiden</a></li>
                    <li><a href="#" class="hover:text-green-500 transition duration-300">Peraturan Menteri</a></li>
                    <li><a href="#" class="hover:text-green-500 transition duration-300">Peraturan Kepala BSN</a></li>
                    <li><a href="#" class="hover:text-green-500 transition duration-300">Peraturan Kepala BSILHK</a></li>
                    <li><a href="#" class="hover:text-green-500 transition duration-300">SK BSILHK</a></li>
                    <li><a href="#" class="hover:text-green-500 transition duration-300">JDIH KLHK</a></li>
                </ul>
            </div>

            <!-- Kolom Download & Social Media -->
            <div>
                <h3 class="text-xl font-bold mb-4 text-white">Download</h3>
                <div class="space-y-4">
                    <button class="w-full bg-orange-500 text-white font-semibold py-3 px-6 rounded-md hover:bg-orange-600 transition-colors duration-300 shadow-lg">
                        Publikasi
                    </button>
                    <button class="w-full bg-orange-500 text-white font-semibold py-3 px-6 rounded-md hover:bg-orange-600 transition-colors duration-300 shadow-lg">
                        Katalog SNI
                ...
                <div class="flex space-x-4 mt-6 justify-center md:justify-start">
                    <a href="https://www.facebook.com/BSILHK/" target="_blank" class="hover:opacity-75">
                        <img src="{{ asset('images/facebook.png') }}" alt="Facebook" class="h-8 w-8">
                    </a>
                    <a href="https://www.instagram.com/BSILHK/" target="_blank" class="hover:opacity-75">
                        <img src="{{ asset('images/instagram.png') }}" alt="Instagram" class="h-8 w-8">
                    </a>
                    <a href="https://www.youtube.com/user/BSILHK" target="_blank" class="hover:opacity-75">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center pt-8 text-sm">
            <div class="text-gray-500 text-center md:text-left">
                &copy; 2024 Badan Standardisasi Instrumen Lingkungan Hidup dan Kehutanan, All Rights Reserved.
            </div>
        </div>
    </div>
</footer>
