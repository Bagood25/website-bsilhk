...
<body class="bg-gray-50 flex flex-col min-h-screen">
    ...
    <!-- Hero Section / Banner -->
    <div class="relative h-64 bg-cover bg-center flex items-center justify-center text-white" style="background-image: url('https://placehold.co/1920x400/10b981/ffffff?text=Banner+Tugas+dan+Fungsi');">
